...
/**
 * Provides a 'MenuPlugAsideBlock' block.
 *
 * @Block(
 *  id = "menu_plug_aside_block",
 *  admin_label = @Translation("Menu plug aside block"),
 * )
 */
class MenuPlugAsideBlock extends BlockBase {
  ...
  public function build() {
    $build = [];
    $build['#theme'] = 'menu_plug_aside_block';
