...
a(function(){a("nav a[href^=\"/"+location.pathname.split("/")[1]+"\"]").addClass("active")}),a(".nav-opener").on({click:function click(){a(".mainNav").toggleClass("shown")}}),a(".mainNav__toggle").prev().attr("aria-haspopup","true"),a(".subNav a").attr("tabindex",-1),a(".mainNav__subNavToggle").click(function(){var b=a(this),c=a(b.parent()),d=a(b.prev()),e=a(b.next());console.log(d),e.hasClass("subNav--expanded")?(a(e).removeClass("subNav--expanded"),a(c).removeClass("withSubNav--expanded"),b.prev().find("a").attr("tabindex",-1)):(a(e).addClass("subNav--expanded"),a(c).addClass("withSubNav--expanded"),b.prev().find("a").removeAttr("tabindex",-1))})})(jQuery);
