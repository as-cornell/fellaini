      ...
      <div class="as-three-up as-three-up--quick-actions" id="as-quick-actions">
        <div class="as-container">
          <a href="/how-apply" class="as-three-up__item">
            <div class="as-quick-action__link as-quick-action__link--become-student">
              <div class="as-icon as-icon--apply"></div>
          ...
          <a href="http://www.cornell.edu/visit/" class="as-three-up__item">
            <div class="as-quick-action__link as-quick-action__link--visit-campus">
              <div class="as-icon as-icon--visit-campus"></div>
              <div class="as-quick-action__copy">
          ...
          <a href="https://securelb.imodules.com/s/1717/giving/interior.aspx?sid=1717&gid=2&pgid=3052&cid=7311&dids=12.5262&bledit=1&appealcode=AS21GOL" class="as-three-up__item">
            <div class="as-quick-action__link as-quick-action__link--make-donation">
              <div class="as-icon as-icon--make-donation"></div>
              <div class="as-quick-action__copy">
