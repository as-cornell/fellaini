...
<div class="as-page__block">
  <div class="as-container">
    ...
    <div class="as-page__content--860">
    ...
    <?php if (!empty($content['field_seventh_body'])) : ?>
      <div class="as-page__content--860">
        <?php print render($content['field_seventh_body']); ?>
      </div>
      <div class="as-cards">
        <?php print render($content['field_seventh_person_block']); ?>
      </div>
    <?php endif; ?>
